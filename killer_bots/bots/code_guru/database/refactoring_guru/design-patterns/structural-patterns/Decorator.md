...
-   [Decorator](https://refactoring.guru/pattern/decorator) lets you change the skin of an object, while [Strategy](https://refactoring.guru/pattern/strategy) lets you change the guts.
